...
export const LightbulbIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c-1.421-.666-2.443-1.897-2.733-3.376C5.165 13.005 5 12.473 5 12c0-1.242.128-2.457.372-3.628.244-1.172.693-2.26 1.284-3.218.59-.958 1.344-1.82 2.23-2.583.886-.764 1.93-1.424 3.092-1.931a11.95 11.95 0 014.5 0c1.162.507 2.206 1.167 3.092 1.931.886.763 1.64 1.625 2.23 2.583.59 1.018.995 2.112 1.228 3.31C18.872 9.543 19 10.758 19 12c0 .473-.165.995-.267 1.494-.102.499-.344 1.018-.68 1.543-.337.526-.76 1.026-1.262 1.488-.502.462-1.08.86-1.722 1.182a11.956 11.956 0 01-4.5 0z" />
    </svg>
);
